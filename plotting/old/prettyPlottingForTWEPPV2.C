...
void prettyPlottingForTWEPPV2(){

	setTDRStyle();

        fileLegacy=new TFile("outputs/DataGCT833DEFIso.root","READONLY");
	...
	c1->cd();
        ...
        TH1F *histo10=(TH1F*)fileLegacy->Get("effi10_PtSecond"); histo10->SetName("effi10");
	TH1F *histo15=(TH1F*)fileLegacy->Get("effi15_PtSecond"); histo15->SetName("effi15");
        TH1F *histo20=(TH1F*)fileLegacy->Get("effi20_PtSecond"); histo20->SetName("effi20");
        TH1F *histo25=(TH1F*)fileLegacy->Get("effi25_PtSecond"); histo25->SetName("effi25");
        TH1F *histo30=(TH1F*)fileLegacy->Get("effi30_PtSecond"); histo30->SetName("effi30");
        TH1F *histo35=(TH1F*)fileLegacy->Get("effi35_PtSecond"); histo35->SetName("effi35");

        TH1F *histonvtx20=(TH1F*)fileLegacy->Get("effi20_nvtxSecond"); histonvtx20->SetName("effinvtx20");
	...
	histo15->Draw("hist,E");
        histo20->Draw("hist,E,sames");
        histo25->Draw("hist,E,sames");
        histo30->Draw("hist,E,sames");
        histo35->Draw("hist,E,sames");
	...
	TLegendEntry *entry; 
        entry=leg->AddEntry(histo20,"Legacy","pl");
        entry=leg->AddEntry(histoIso20,"Stage1","pl");
	leg->Draw();
	...
	leg2->SetBorderSize(0);
        entry=leg2->AddEntry(histoIso15,"SingleIsoEG15","p");
        entry=leg2->AddEntry(histoIso20,"SingleIsoEG20","p");
        entry=leg2->AddEntry(histoIso25,"SingleIsoEG25","p");
        entry=leg2->AddEntry(histoIso30,"SingleIsoEG30","p");
        entry=leg2->AddEntry(histoIso35,"SingleIsoEG35","p");
        leg2->Draw();
