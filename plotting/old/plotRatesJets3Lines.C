...
void plotRatesJets3Lines(int version=0)
{
        setTDRStyle();


//TFile*   file1=new TFile("RATEALLNEWNOPU.root");
TFile*   file1=new TFile("RATEALLNEW-run254790.root");
TFile*   file2=new TFile("RATEJETOLDRCTCALIBLauraJet-run254790.root");
TFile*   file3=new TFile("RATEJETOLDRCTCALIBLauraJet-run254790.root");


TString DIR1="allJetRate/Ntuple"; 
TString DIR2="allJetRate/Ntuple";
TString DIR3="allJetRateGCT/Ntuple";

TString Legend1="Stage1, allJet (RCT calib + JetCalib V1)";
TString Legend2="Stage1, allJet (No RCT calib + JetCalib V0)";
TString Legend3="Legacy, allJet (No RCT calib + JetCalib 2012)";
