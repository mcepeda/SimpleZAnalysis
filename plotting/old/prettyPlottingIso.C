...
void prettyPlottingIso(){

	setTDRStyle();

	file833DEFSingleEG=new TFile("outputs/DataStage1833DEF.root","READONLY");
	file833DEFSingleIsoEG=new TFile("outputs/DataStage1833DEFIso.root","READONLY");
