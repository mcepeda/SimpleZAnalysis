...
void effis25V2(){
	...
	TFile *fileDataStage1833= new TFile("newroots/effiNEWPURECOMETNOHF.root");
        TFile *fileMCStage125ns= new TFile("newroots/dymini.root");
        TFile *fileDataGCT833= new TFile("newroots/effiNEWPURECOMETNOHF.root");
	...
	treeMCStage125nsDEF.Loop("outputs/MCStage125nsDEF.root", 2008.4*3*LUMI/1.56649e+09,false);

	TTree* tupleMCStage125nsDEFIso=  (TTree*)fileMCStage125ns->Get("effitreeminiIsoDEFAULT/Ntuple");
	effis treeMCStage125nsDEFIso;
	treeMCStage125nsDEFIso.Init(tupleMCStage125nsDEFIso);
	treeMCStage125nsDEFIso.Loop("outputs/MCStage125nsDEFIso.root", 2008.4*3*LUMI/1.56649e+09,false);


        TTree* tupleDataGCT833DEF=  (TTree*)fileDataGCT833->Get("effitreeminiGCTDEFAULT/Ntuple");
        effis treeGCT833DEF;
        treeGCT833DEF.Init(tupleDataGCT833DEF);
        treeGCT833DEF.Loop("outputs/DataGCT833DEF.root", 1,false);

        TTree* tupleDataGCT833DEFIso=  (TTree*)fileDataGCT833->Get("effitreeminiGCTDEFAULTIso/Ntuple");
        effis treeGCT833DEFIso;
        treeGCT833DEFIso.Init(tupleDataGCT833DEFIso);
        treeGCT833DEFIso.Loop("outputs/DataGCT833DEFIso.root", 1,false);


	TTree* tupleDataStage1833DEF=  (TTree*)fileDataStage1833->Get("effitreeminiDEFAULT/Ntuple");
	...
	TTree* tupleDataStage1833DEFIso=  (TTree*)fileDataStage1833->Get("effitreeminiIsoDEFAULT/Ntuple");
	effis treeStage1833DEFIso;
	treeStage1833DEFIso.Init(tupleDataStage1833DEFIso);
	treeStage1833DEFIso.Loop("outputs/DataStage1833DEFIso.root", 1,false);

	TTree* tupleDataStage1833=  (TTree*)fileDataStage1833->Get("effitreemini/Ntuple");
	effis treeStage1833;
	treeStage1833.Init(tupleDataStage1833);
	treeStage1833.Loop("outputs/DataStage1833.root", 1,false);

	TTree* tupleDataStage1833Iso=  (TTree*)fileDataStage1833->Get("effitreeminiIso/Ntuple");
	effis treeStage1833Iso;
	treeStage1833Iso.Init(tupleDataStage1833Iso);
	treeStage1833Iso.Loop("outputs/DataStage1833Iso.root", 1,false);


	TFile *fileDataStage125ns= new TFile("newroots/effiNEWPU.root");
	TTree* tupleDataStage125nsDEF=  (TTree*)fileDataStage125ns->Get("effitreeminiDEFAULT/Ntuple");
	...
	TTree* tupleDataStage125nsDEFIso=  (TTree*)fileDataStage125ns->Get("effitreeminiIsoDEFAULT/Ntuple");
	effis treeStage125nsDEFIso;
	treeStage125nsDEFIso.Init(tupleDataStage125nsDEFIso);
	treeStage125nsDEFIso.Loop("outputs/DataStage125nsDEFIso.root", 1,false);

	TTree* tupleDataStage125ns=  (TTree*)fileDataStage125ns->Get("effitreemini/Ntuple");
	effis treeStage125ns;
	treeStage125ns.Init(tupleDataStage125ns);
	treeStage125ns.Loop("outputs/DataStage125ns.root", 1,false);

	TTree* tupleDataStage125nsIso=  (TTree*)fileDataStage125ns->Get("effitreeminiIso/Ntuple");
	effis treeStage125nsIso;
	treeStage125nsIso.Init(tupleDataStage125nsIso);
	treeStage125nsIso.Loop("outputs/DataStage125nsIso.root", 1,false);
...
void effis::Loop(TString outputFile="outputs/Data.root", double scale=1, bool forQCD=false)
{
	...
	const int binsPt=13;
	double ptbins[14]={0,5,10,15,20,25,30,35,40,45,50,60,70,100};
...
//        double ptbins[21]={0,5,10,15,20,22.5,25,27.5,30,32.5,35,37.5,40,45,50,60,70,100};
	...
	TH2F *ResSecondPtTrig2DEta = new TH2F("ResSecondPtTrig2DEta","",30,-3,3,100,-1,1);  ResSecondPtTrig2DEta->Sumw2();
	...
	TH1F *recoEtaLead = new TH1F("recoEtaLead","",30,-3,3); recoEtaLead->Sumw2();
	TH1F *recoEtaSecond = new TH1F("recoEtaSecond","",30,-3,3); recoEtaSecond->Sumw2();
	TH1F *recoEtaSecondr20 = new TH1F("recoEtaSecondr20","",30,-3,3); recoEtaSecondr20->Sumw2();
	TH1F *recoEtaSecondr25 = new TH1F("recoEtaSecondr25","",30,-3,3); recoEtaSecondr25->Sumw2();
	TH1F *recoEtaSecondr30 = new TH1F("recoEtaSecondr30","",30,-3,3); recoEtaSecondr30->Sumw2();
	TH1F *recoEtaSecondr35 = new TH1F("recoEtaSecondr35","",30,-3,3); recoEtaSecondr35->Sumw2();
	TH1F *recoEtaSecondr40 = new TH1F("recoEtaSecondr40","",30,-3,3); recoEtaSecondr40->Sumw2();
	TH1F *recoEtaSecondr45 = new TH1F("recoEtaSecondr45","",30,-3,3); recoEtaSecondr45->Sumw2();

	TH1F *recoEtaLeadTrig = new TH1F("recoEtaLeadTrig","",30,-3,3); recoEtaLeadTrig->Sumw2();

	TH1F *recoEtaSecondTrig15 = new TH1F("recoEtaSecondTrig15","",30,-3,3); recoEtaSecondTrig15->Sumw2();
	TH1F *recoEtaSecondTrig20 = new TH1F("recoEtaSecondTrig20","",30,-3,3); recoEtaSecondTrig20->Sumw2();
	TH1F *recoEtaSecondTrig25 = new TH1F("recoEtaSecondTrig25","",30,-3,3); recoEtaSecondTrig25->Sumw2();
	TH1F *recoEtaSecondTrig30 = new TH1F("recoEtaSecondTrig30","",30,-3,3); recoEtaSecondTrig30->Sumw2();
	TH1F *recoEtaSecondTrig35 = new TH1F("recoEtaSecondTrig35","",30,-3,3); recoEtaSecondTrig35->Sumw2();

	TH1F *l1EtaLead = new TH1F("l1EtaLead","",30,-3,3); l1EtaLead->Sumw2();
	TH1F *l1EtaSecond = new TH1F("l1EtaSecond","",30,-3,3);l1EtaSecond->Sumw2();
	...
	for (Long64_t jentry=0; jentry<nentries;jentry++) {
        ...
        TGraphAsymmErrors *effi_PtLead_Jet50= new TGraphAsymmErrors(hLeadPtJetTrig50,hLeadPtJet);
        effi_PtLead_Jet50->SetName("effi_PtLead_Jet50");

	TGraphAsymmErrors *effi_PtLead= new TGraphAsymmErrors(recoBinPtLeadTrig,recoBinPtLead);
	effi_PtLead->SetName("effi_PtLead");

        TGraphAsymmErrors *effiHLT_PtLead= new TGraphAsymmErrors(recoBinPtLead,recoBinPtLead);
        effiHLT_PtLead->SetName("effiHLT_PtLead");

	TGraphAsymmErrors *effi10_PtSecond= new TGraphAsymmErrors(recoBinPtSecondTrig10,recoBinPtSecond);
        effi10_PtSecond->SetName("effi10_PtSecond");

        TGraphAsymmErrors *effi15_PtSecond= new TGraphAsymmErrors(recoBinPtSecondTrig15,recoBinPtSecond);
        effi15_PtSecond->SetName("effi15_PtSecond");

        TGraphAsymmErrors *effi20_PtSecond= new TGraphAsymmErrors(recoBinPtSecondTrig20,recoBinPtSecond);
        effi20_PtSecond->SetName("effi20_PtSecond");


        TGraphAsymmErrors *effi25_PtSecond= new TGraphAsymmErrors(recoBinPtSecondTrig25,recoBinPtSecond);
        effi25_PtSecond->SetName("effi25_PtSecond");

        TGraphAsymmErrors *effi30_PtSecond= new TGraphAsymmErrors(recoBinPtSecondTrig30,recoBinPtSecond);
        effi30_PtSecond->SetName("effi30_PtSecond");

        TGraphAsymmErrors *effi35_PtSecond= new TGraphAsymmErrors(recoBinPtSecondTrig35,recoBinPtSecond);
        effi35_PtSecond->SetName("effi35_PtSecond");

        TH1F *effiH15_PtSecond=(TH1F*)recoBinPtSecondTrig15->Clone();
        effiH15_PtSecond->SetName("effiH15_PtSecond");
        effiH15_PtSecond->Divide(recoBinPtSecondTrig15,recoBinPtSecond,1,1,"B");

        TH1F *effiH20_PtSecond=(TH1F*)recoBinPtSecondTrig20->Clone();
        effiH20_PtSecond->SetName("effiH20_PtSecond");
        effiH20_PtSecond->Divide(recoBinPtSecondTrig20,recoBinPtSecond,1,1,"B");
	
	TH1F *effiH20_PtSecond_Take2=(TH1F*)recoBinPtSecond->Clone(); effiH20_PtSecond_Take2->SetName("effiH20_PtSecond_Take2");	

	for (int i=0; i<effiH20_PtSecond_Take2->GetNbinsX(); i++){
			double a=recoBinPtSecondTrig20->GetBinContent(i);
			double b=recoBinPtSecond->GetBinContent(i);
			double eff=0; double error=0;
			if(b!=0){
			eff=a/b;
			error=sqrt(eff*(1-eff)/b);
			}	
			effiH20_PtSecond_Take2->SetBinContent(i,eff);
			effiH20_PtSecond_Take2->SetBinError(i,error);
	}


        TH1F *effiH25_PtSecond=(TH1F*)recoBinPtSecondTrig25->Clone();
        effiH25_PtSecond->SetName("effiH25_PtSecond");
        effiH25_PtSecond->Divide(recoBinPtSecondTrig25,recoBinPtSecond,1,1,"B");

        TH1F *effiH30_PtSecond=(TH1F*)recoBinPtSecondTrig30->Clone();
        effiH30_PtSecond->SetName("effiH30_PtSecond");
        effiH30_PtSecond->Divide(recoBinPtSecondTrig30,recoBinPtSecond,1,1,"B");

        TH1F *effiH35_PtSecond=(TH1F*)recoBinPtSecondTrig35->Clone();
        effiH35_PtSecond->SetName("effiH35_PtSecond");
        effiH35_PtSecond->Divide(recoBinPtSecondTrig35,recoBinPtSecond,1,1,"B");





        TGraphAsymmErrors *effi15_PtSecondEB= new TGraphAsymmErrors(recoBinPtSecondEBTrig15,recoBinPtSecondEB);
        effi15_PtSecondEB->SetName("effi15_PtSecondEB");

        TGraphAsymmErrors *effi20_PtSecondEB= new TGraphAsymmErrors(recoBinPtSecondEBTrig20,recoBinPtSecondEB);
        effi20_PtSecondEB->SetName("effi20_PtSecondEB");

        TGraphAsymmErrors *effi25_PtSecondEB= new TGraphAsymmErrors(recoBinPtSecondEBTrig25,recoBinPtSecondEB);
        effi25_PtSecondEB->SetName("effi25_PtSecondEB");

        TGraphAsymmErrors *effi30_PtSecondEB= new TGraphAsymmErrors(recoBinPtSecondEBTrig30,recoBinPtSecondEB);
        effi30_PtSecondEB->SetName("effi30_PtSecondEB");

        TGraphAsymmErrors *effi35_PtSecondEB= new TGraphAsymmErrors(recoBinPtSecondEBTrig35,recoBinPtSecondEB);
        effi35_PtSecondEB->SetName("effi35_PtSecondEB");




        TGraphAsymmErrors *effi15_PtSecondEE= new TGraphAsymmErrors(recoBinPtSecondEETrig15,recoBinPtSecondEE);
        effi15_PtSecondEE->SetName("effi15_PtSecondEE");
        
        TGraphAsymmErrors *effi20_PtSecondEE= new TGraphAsymmErrors(recoBinPtSecondEETrig20,recoBinPtSecondEE);
        effi20_PtSecondEE->SetName("effi20_PtSecondEE");
        
        TGraphAsymmErrors *effi25_PtSecondEE= new TGraphAsymmErrors(recoBinPtSecondEETrig25,recoBinPtSecondEE);
        effi25_PtSecondEE->SetName("effi25_PtSecondEE");
        
        TGraphAsymmErrors *effi30_PtSecondEE= new TGraphAsymmErrors(recoBinPtSecondEETrig30,recoBinPtSecondEE);
        effi30_PtSecondEE->SetName("effi30_PtSecondEE");

        TGraphAsymmErrors *effi35_PtSecondEE= new TGraphAsymmErrors(recoBinPtSecondEETrig35,recoBinPtSecondEE);
        effi35_PtSecondEE->SetName("effi35_PtSecondEE");



        TGraphAsymmErrors *effi15_EtaSecond= new TGraphAsymmErrors(recoEtaSecondTrig15,recoEtaSecond);
        effi15_EtaSecond->SetName("effi15_EtaSecond");
        
        TGraphAsymmErrors *effi20_EtaSecond= new TGraphAsymmErrors(recoEtaSecondTrig20,recoEtaSecond);
        effi20_EtaSecond->SetName("effi20_EtaSecond");
        
        TGraphAsymmErrors *effi25_EtaSecond= new TGraphAsymmErrors(recoEtaSecondTrig25,recoEtaSecond);
        effi25_EtaSecond->SetName("effi25_EtaSecond");
        
        TGraphAsymmErrors *effi30_EtaSecond= new TGraphAsymmErrors(recoEtaSecondTrig30,recoEtaSecond);
        effi30_EtaSecond->SetName("effi30_EtaSecond");

        TGraphAsymmErrors *effi35_EtaSecond= new TGraphAsymmErrors(recoEtaSecondTrig35,recoEtaSecond);
        effi35_EtaSecond->SetName("effi35_EtaSecond");


	TGraphAsymmErrors* effi20_nvtxSecond= new TGraphAsymmErrors(reconvtxSecondTrig20,reconvtx);
	effi20_nvtxSecond->SetName("effi20_nvtxSecond");

        TGraphAsymmErrors* effi20_nvtxSecondEE= new TGraphAsymmErrors(reconvtxSecondEETrig20,reconvtx);
        effi20_nvtxSecondEE->SetName("effi20_nvtxSecondEE");

        TGraphAsymmErrors* effi20_nvtxSecondEB= new TGraphAsymmErrors(reconvtxSecondEBTrig20,reconvtx);
...
//,"cl=0.683 b(1,1) mode"
	...
	effi35_PtSecond->Write();
        ...
        effiH15_PtSecond->Write();
        effiH20_PtSecond->Write();
        effiH25_PtSecond->Write();
        effiH30_PtSecond->Write();
        effiH35_PtSecond->Write();
